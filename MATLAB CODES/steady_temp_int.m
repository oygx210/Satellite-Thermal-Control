function steady_temp_int(q_int)
...
fileID = fopen('steadytemp_int.txt','a+');
fprintf(fileID,'Temperature of the satellite as a function of orbital position at an altitude = %i is given by %.2f + %.2fcos(Ф-%.2f)\n', H, abs(temp_mean_sat(1)), abs(temp_amp_sat(1)), abs(si(1)));
fclose(fileID);
